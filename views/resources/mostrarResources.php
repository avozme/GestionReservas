		...
		echo "<table class= 'table table-hover'>";
			...
			foreach($data['listaResources'] as $resources) {
				echo "<tr id='resources".$resources->id."'>";
					...
					echo "<td><strong>".$resources->name."</strong><br><span style='font-size: 80%'>".$resources->description." - ".$resources->location."</span></td>";
					...
					if($_SESSION['type'] ==  "admin"){
						...
						echo "<td><button class='btn btn-danger'><a href='index.php?controller=ResourceController&action=borrarResourcesAjax&id=".$resources->id."' style='color: white'>Eliminar</button></a></td>";
					}
				echo "</tr>";
			}
