...
<head>
    ...
    <title>Gestión de reservas | IES Celia Viñas</title>
       ...
       echo" <a class='navbar-brand' href='index.php?controller=ReservationController&action=mostrar&date=date' >Mis Reservas</a>
        ...
        <div class='collapse navbar-collapse' id='navbarTogglerDemo03'>
            <ul class='navbar-nav mr-auto mt-2 mt-lg-0'>
                ...
                <li class='nav-item'>
                    <a class='nav-link' href='index.php?controller=ReservationController&action=mostrar'>Reservas</a>
                </li>";
...
?>
<span style='justify-content: space-around; font-size: 150%' class='navbar-collapse text-primary'>Gestión de reservas | IES Celia Viñas | Versión alpha 0.1</span>
