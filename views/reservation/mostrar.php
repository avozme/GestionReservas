				...
				foreach($data['listaReservation'] as $reservation) {
					...
					echo "<tr id='reservation".$reservation->id."'>";
						...
						if($_SESSION['type'] ==  "admin" || $data['idUsuario'] == $reservation->userid){
							...
							echo "<td><button class='btn btn-danger' disabled>Cancelar</button></td>";
							echo "<td><button class='btn btn-warning' disabled>Modificar</button></td>";
						}
					echo "</tr>";
				}
